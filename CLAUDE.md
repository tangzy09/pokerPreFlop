...
### i18n (N-language, English default + fallback)
...
- **Adding a language touches exactly 3 places**: `I18N_SUPPORTED` + `I18N_NATIVE` + `js/locales/<code>.js`. The `detect()` prefix table is **derived from `I18N_SUPPORTED`** — never hand-write a second one.
