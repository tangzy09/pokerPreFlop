...
_tpl('ach.五十手通关','五十手通关','50-hand clear'); _tpl('ach.GTO 机器','GTO 机器','GTO machine');
...
_tpl('profAggro', '常该跟注却下重注', 'often bet big when you should call');
...
_tpl('reason.sq.call', '<b>{hand}</b> 适合<b>跟注</b>（overcall）：{clause}；不够强到挤压，但弃了可惜。',
